...
import org.w3c.api.SyntaxException;
...
public interface CSSLCH extends CSSColorValue {
	 ...
	 * @throws SyntaxException if the component is not a &lt;percentage&gt;
	 */
	void setL(CSSNumericValue l) throws SyntaxException;
	 ...
	 * @throws SyntaxException if the component is not a &lt;percentage&gt;
	 */
	void setC(CSSNumericValue c) throws SyntaxException;
	 ...
	 * @throws SyntaxException if the component is not an &lt;angle&gt;
	 */
	void setH(CSSNumericValue h) throws SyntaxException;
	 ...
	 * @throws SyntaxException if alpha is not a percentage.
	 */
	void setAlpha(CSSNumericValue alpha) throws SyntaxException;
