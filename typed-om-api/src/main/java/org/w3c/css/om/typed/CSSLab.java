...
public interface CSSLab extends CSSColorValue {
	 ...
	 * 
	 * @param a the {@code a} component.
	 * @throws SyntaxException if the component is not a &lt;number&gt;
	 */
	void setA(CSSNumericValue a) throws SyntaxException;
	 ...
	 * @throws SyntaxException if the component is not a &lt;number&gt;
	 */
	void setB(CSSNumericValue b) throws SyntaxException;
